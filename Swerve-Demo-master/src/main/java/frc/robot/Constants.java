...
public final class Constants 
{
    ...
    public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 12; // Set front left module drive motor ID
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 10; //  Set front left module steer motor ID
    ...
    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 17; //  Set back left drive motor ID
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 18; //  Set back left steer motor ID
    ...
    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 4; //  Set back right drive motor ID
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 8; //  Set back right steer motor ID
